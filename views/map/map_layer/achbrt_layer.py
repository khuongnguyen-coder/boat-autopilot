...
Defines ACHBRTLayer, a specialized GeoJSONLayer for rendering
Depth Areas (ACHBRT) from ENC GeoJSON data.

Features:
    - Preconfigured defaults for depth/brt areas (blueish color scheme).
...
class ACHBRTLayer(GeoJSONLayer):
    ...
    def __init__(
        ...
        super().__init__(
            filepath=filepath,
            title="Depth Area",           # Human-readable name
